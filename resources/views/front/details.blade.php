...
<body>
    <main
        ...
        <section id="Thumbnail" class="relative {{ !$carStore->is_open ? 'bg-gray-200 opacity-50' : '' }}">
            ...
            <div class="px-4 flex justify-between items-center transform translate-y-1/2 absolute bottom-0 z-10 w-full">
                <p
                    class="badge w-fit rounded-full p-[6px_10px] {{ !$carStore->is_open ? 'bg-[#F12B3E]' : 'bg-[#41BE64]' }} font-bold text-xs leading-[18px] text-white">
            ...
            @if ($carStore->is_open)
                @if ($carStore->is_full)
                    <a href="" class="rounded-full p-[12px_20px] bg-[#EEEFF4] font-bold text-[#AAADBF]">Full
                        Booked</a>
                @else
                    <a href="{{ route('front.booking', $carStore) }}"
            ...
            <div class="relative p-4 px-9 w-full max-w-2xl max-h-full">
                ...
                <div
                    ...
                    <div class="flex flex-col px-4 gap-4">
                        ...
                        <p class="leading-[28px]">Menggunakan metode golden touch maka pencucian mobil akan lebih
                            cepat, bersih, dan tidak mudah kotor kembali.</p>
                        <button
